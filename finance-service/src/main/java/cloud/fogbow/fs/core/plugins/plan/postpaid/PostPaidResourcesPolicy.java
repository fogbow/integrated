...
public class PostPaidResourcesPolicy implements ResourcesPolicy {
    private static Logger LOGGER = Logger.getLogger(PostPaidResourcesPolicy.class);
    ...
    public PostPaidResourcesPolicy(DebtsPaymentChecker debtsChecker, 
            InvoiceManager invoiceManager, RasClient rasClient, long timeToWaitBeforeStopping) {
        this(debtsChecker, invoiceManager, rasClient, timeToWaitBeforeStopping, new TimeUtils());
    }
